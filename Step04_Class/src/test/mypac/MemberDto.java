...
public class MemberDto {
	...
	public MemberDto() {} //생성자 : new MemberDto();
	...
	public MemberDto(int num,String name,String addr) { //생성자 : new MemberDto(1, "xxx", "xxx");
		System.out.println("MemberDto() 생성자가 호출됨!");
		//생성자로 전달 받은 값을 필드에 저장하기
		this.num=num; 
		//this : 객체의 참조값 , 객체가 생성될때까지 값은 알수없음
		//MemberDto a =this;
		this.name=name;
		this.addr=addr;
	}
	//public MemverDto test(){
	//    return this;
    //}
