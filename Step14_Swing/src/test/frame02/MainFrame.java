...
public class MainFrame extends JFrame{
	...
	public MainFrame(String title) {
		...
		//레이아웃 메니저 지정하기
		setLayout(new FlowLayout()); //FlowLayout() : 물 흐르듯이 배치되는 레이아웃 
		//버튼 3 개를 만들고 
		...
		add(deleteBtn);
		//전송 버튼에 리스너 등록하기 
		sendBtn.addActionListener(new ActionListener() { //1. 버튼의 갯수만큼 
			@Override
		...
		//수정 버튼에 리스너 등록하기
		updateBtn.addActionListener((e)->{ //2.
			JOptionPane.showMessageDialog(MainFrame.this, "수정합니다.");
		});
		//삭제 버튼에 리스너 등록하기
		deleteBtn.addActionListener((e)->{ //3. 
