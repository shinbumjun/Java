...
public class ClientFrame extends JFrame 
	...
	BufferedReader br;
	JTextArea ta;
	String chatName; //*대화명을 저장할 필드, 입력하지 않으면 바보
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		//2. BufferedWriter 객체를 이용해서 출력한다. 서버에 문자열 전송(출력)
		try {
	...
	//*서버에서 문자열이 전송되는지 지속적으로 대기하는 스레드 객체를 생성할 클래스 설계, 스레드 2개
