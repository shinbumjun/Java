...
public class FileChooseFrame extends JFrame implements ActionListener{
	...
	public void selectGeneral() {
		...
		if(result == JFileChooser.APPROVE_OPTION) {//파일을 선택하고 확인을 눌렀을때, 0
		...
		}else if(result == JFileChooser.CANCEL_OPTION) { //취소 버튼을 눌렀을때, 1
			JOptionPane.showMessageDialog(this, "취소 버튼을 눌렀네요?");
		}else if(result == JFileChooser.ERROR_OPTION) { //-1
	...
	public void selectText() {
		...
		FileNameExtensionFilter filter=
				new FileNameExtensionFilter("텍스트 파일", "txt"); //설명, 확장명
